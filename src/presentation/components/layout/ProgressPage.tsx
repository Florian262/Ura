  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12 animate-fade-in space-y-8 relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 z-10 relative">
        ...
        <div className="glass-panel rounded-2xl p-6 border border-[#E9ECEF] bg-white flex flex-col justify-between relative overflow-hidden shadow-sm">
          <div>
          ...
          {/* Progress bar */}
          <div className="w-full bg-[#E9ECEF] border border-neutral-200 h-2 mt-6 rounded-full overflow-hidden">
            <div 
              className="bg-[#3A5A40] h-full transition-all duration-500 rounded-full"
        ...
        <div className="glass-panel rounded-2xl p-6 border border-[#E9ECEF] bg-white flex flex-col justify-between relative overflow-hidden shadow-sm">
          ...
          {stats.lastSession ? (
            <button
              ...
              className="mt-6 w-full text-center px-4 py-2.5 bg-[#3A5A40] hover:bg-[#2A3F2E] border border-[#3A5A40] text-white rounded-xl text-xs font-bold transition cursor-pointer shadow-sm hover:shadow"
            >
      ...
      <div className="glass-panel rounded-2xl p-6 border border-[#E9ECEF] bg-white z-10 relative shadow-sm">
      ...
      <div className="glass-panel border border-[#c0392b]/30 rounded-2xl p-6 bg-white flex flex-col sm:flex-row justify-between items-center gap-4 mt-8 z-10 relative shadow-sm">
        ...
        <button
          ...
          className="px-5 py-2.5 bg-[#c0392b]/10 hover:bg-[#c0392b]/20 border border-[#c0392b] text-[#c0392b] font-bold rounded-xl text-xs uppercase tracking-wider transition cursor-pointer shadow-xs"
        >
